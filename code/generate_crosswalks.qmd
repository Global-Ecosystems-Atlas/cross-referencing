...
### Pixel values
```{r}
efg_pixelvalues <- read_csv( "https://raw.githubusercontent.com/Global-Ecosystems-Atlas/metadata/refs/heads/main/pixel-values/efg_pixelvalues.csv", show_col_types = FALSE) |> 
...
dat_out <- dat_long |> 
  ...
  dat_out |>
    group_split(layer_name) |>
    walk(function(df) {

      split_filename <- glue::glue("{df$Source_ID[1]}_{df$layer_name[1]}_GEA_crosswalk_table.csv")
